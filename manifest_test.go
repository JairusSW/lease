...
import (
	...
	leaseregister "github.com/JairusSW/lease/register"
...
func TestManifestMatchesCatalogMetadata(t *testing.T) {
	...
	providers := leaseregister.Providers()
	if len(providers) != 1 {
	...
	assertProviderCatalogCurrent(t, "github.com/JairusSW/lease/register", providers)
}
